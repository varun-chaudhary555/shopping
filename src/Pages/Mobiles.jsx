...
function Mobiles() {
  ...
  /* ================= APPLY FILTERS ================= */
  let filteredProducts = mobileProducts;

  if (selectedStorage) {
    filteredProducts = filteredProducts.filter((p) => {
      if (!p.size) return false;
      const ps = p.size.replace(/\s+/g, "").toLowerCase();
      const ss = selectedStorage.replace(/\s+/g, "").toLowerCase();
      return ps.includes(ss);
    });
  }
  ...
  }, [selectedStorage, selectedBrand, selectedRating, priceRange, sortOrder]);
  ...
  const brands = [
    ...new Set(mobileProducts.map((p) => p.brand).filter(Boolean)),
  ];
  ...
  return (
    <div className="px-4 md:px-10">
      ...
      {/* ================= HEADER ================= */}
      <div className="text-center font-bold mt-8 text-3xl">
        Mobiles
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        {/* ================= FILTER SIDEBAR ================= */}
        <div className="w-full md:w-64 border p-4 rounded h-fit">
          ...
          <h3 className="font-bold mt-5 mb-2">Storage</h3>
        ...
        {/* ================= PRODUCTS GRID ================= */}
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
