...
function Toys() {
  ...
  /* ================= APPLY FILTERS ================= */
  let filteredProducts = toysProducts;
  ...
  }, [selectedBrand, selectedRating, priceRange, sortOrder]);
  ...
  const brands = [
    ...new Set(toysProducts.map((p) => p.brand).filter(Boolean)),
  ].slice(0, 8);
  ...
  return (
    <div className="px-4 md:px-10">
      ...
      {/* HEADER */}
      <div className="font-bold text-center mt-8 text-3xl">
        Toys
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 md:mt-8 mb-10">
