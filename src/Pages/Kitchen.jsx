...
function Kitchen() {
  ...
  let filteredProducts = kitchenProducts;
  ...
  const brands = [
    ...new Set(kitchenProducts.map((p) => p.brand).filter(Boolean)),
  ].slice(0, 8);
  ...
  return (
    <div className="px-4 md:px-10">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        {/* PRODUCTS GRID */}
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
