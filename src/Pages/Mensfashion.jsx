  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="text-xl md:text-2xl text-center mt-2 font-bold">
          Filter
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        {/* FILTER SIDEBAR */}
        <div className="w-full md:w-64 md:ml-10 mt-8 border p-4 rounded h-fit">
          ...
          {[...new Set(mensProducts.map((p) => p.brand))].map((brand) => (
        ...
        <div className="flex-1 mt-8 mx-4 md:ml-20 md:mr-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 mb-10">
